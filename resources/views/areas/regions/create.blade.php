...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item current">Nouvelle</li>
@endsection

@section('content')
<div class="page-header">
    <h1 class="page-title">Nouvelle région</h1>
</div>

<div class="card" style="max-width:600px">
    <div class="card-body">
        <form method="POST" action="{{ route('areas.regions.store') }}">
            @csrf
            <div class="form-group">
                <label class="form-label required">Nom de la région</label>
                <input type="text" name="nom" class="form-input" value="{{ old('nom') }}" required autofocus>
